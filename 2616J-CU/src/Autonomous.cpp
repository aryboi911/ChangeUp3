...
void progSkills(){
  ...
  LeftIntake.spin(fwd, 100, pct);
  RightIntake.spin(fwd, 100, pct);
  IgnoreX(23, 59.5, 1, 2.1, 60, 35, 0.5);
 //increase y
  LeftIntake.stop(brake);
  RightIntake.stop(brake);
  Indexer.stop(brake);
  IgnoreY(19, 64, -1, 2.1, 60, 35, 0.5);
  Indexer.spin(fwd, 100, pct);
  //increase y
  ...
  LeftIntake.spin(fwd, 100, pct);
  RightIntake.spin(fwd, 100, pct);
  IgnoreX(34, 100.5, 1, 2.1, 60, 35, 0.5);
  LeftIntake.stop(brake);
  RightIntake.stop(brake);
  backLinear(-10, -20, 2);
  IgnoreY(15.75, 125, -1, 2.1, 60, 35, 0.5);
  //lower x
  Sorter.spin(fwd, 13, volt);
  wait(300, msec);
  Indexer.stop(brake);
  ...
  //Increase X
  Indexer.spin(fwd, 100, pct);
  IgnoreY(72, 108, 1, 2.1, 60, 35, 0.5);
  Indexer.stop(brake);
  RightIntake.stop(brake);
  LeftIntake.stop(brake);
  //Increase X
  Indexer.stop(brake);
  IgnoreX(75, 116.5, -1, 2.1, 60, 35, 0.5);
  Indexer.spin(fwd, 100, pct);
  Sorter.spin(fwd, 13, volt);
  wait(600, msec);
  Sorter.stop(hold);
  ...
  RightIntake.spin(fwd, 100, pct); 
  Indexer.spin(fwd, 100, pct);
  IgnoreY(121.5, 116, 1, 1.9, 60, 35, 0.5);
  Indexer.stop(brake);
  LeftIntake.stop(brake);
  RightIntake.stop(brake);

  goTo(132, 119, -1, 2.1, 60, 35, 0.5);
  Indexer.spin(fwd, 100, pct);
  Sorter.spin(fwd, 13, volt);
  wait(600, msec);
  Sorter.stop(hold);
...
void homeRow(){
  ...
  RightIntake.spin(fwd, 100, pct);
  Indexer.spin(fwd, 100, pct);
  IgnoreY(145.25, 1, -1, 2, 60, 45, 0.5);
  LeftIntake.stop(brake);
  RightIntake.stop(brake);
  Sorter.spin(fwd, 100, pct);
  wait(500, msec);
...
void Orcah(){
  ...
  RightIntake.stop(brake);
  turnCurve(16, 15, 70);
  turnCurve(53.5, -50, -85);
  IgnoreX(85.25, 14.3, -1, 2.2, 60, 60, 0.5);
  ...
  IgnoreY(148.25, 5, -1, 1.75, 60, 35, 0.5);
  backLinear(-6, -40, 4);
